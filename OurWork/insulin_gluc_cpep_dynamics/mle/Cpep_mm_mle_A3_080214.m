function Cpep_mm_mle_A3_080214
...
pause
if 1
p_init = [gamma2, h,  x0(1)];
%3 known parameters:
p_fix = [k01, k21, k12, x0(2)];
end
...
% p_est = [gamma2, h,  x0(1)];
% p_fix = [k01, k21, k12, x0(2)];
p = [p_est(1), p_est(2), p_fix(1), p_fix(2), p_fix(3)];
%x0 = [x0]
x0 = [p_est(3), p_fix(4)];
...
disp([' CP0 = ', num2str(p_est(3)), ' +/- ', num2str(stdp(3))])

disp(' Initial conditions:')
disp([' x0(1) = ', num2str(p_est(3)), ' +/- ', num2str(stdp(3))])
disp([' x0(2) = ', num2str(p_fix(4))])
disp(' ')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function e = err_fn(p_var, p_fix,tspan,tgc)
p = [p_var(1), p_var(2),  p_fix(1), p_fix(2), p_fix(3)];
