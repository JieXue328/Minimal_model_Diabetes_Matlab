...
% p_est = [gamma1, h, n,I0]
p = [p_est(1), p_est(2), p_est(3), p_est(4) p_fix(2)];
%x0 = [x0]
x0 = [p_fix(1)];
...
p = [p_var(1), p_var(2), p_var(3),p_var(4), p_fix(2)];

x0 = [p_fix(1)];
ins = ins_sim(tspan,x0,tgi, p,0);

weight1 = (tspan<5)*0;
weight2 = (tspan >=5 & tspan<=100)*10;
weight3 = (tspan>100)*1;
