...
pause
if 1
p_init = [m, alpha, beta, h, k01,k21, k12,x0(1)];
%3 known parameters:
p_fix = [x0(2),x0(3),x0(4)];
end
...
% p_est = [m, alpha, beta, h, k01,k21, k12];
p = [p_est(1), p_est(2), p_est(3), p_est(4), p_est(5), p_est(6),p_est(7)];
%x0 = [x0]
x0 = [p_est(8), p_fix(1), p_fix(2), p_fix(3)];
...
disp([' x0(1) = ', num2str(p_est(8)), ' +/- ', num2str(stdp(8))])
disp([' x0(2) = ', num2str(p_fix(1))])
disp([' x0(3) = ', num2str(p_fix(2))])
disp([' x0(4) = ', num2str(p_fix(3))])
disp(' ')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function e = err_fn(p_var, p_fix,tspan,tgc)
p = [p_var(1), p_var(2), p_var(3),p_var(4), p_var(5),p_var(6),p_var(7)];

x0 = [p_var(8), p_fix(1), p_fix(2), p_fix(3)];
